...
| <a name="module_internal_alb_alarms"></a> [internal\_alb\_alarms](#module\_internal\_alb\_alarms) | git@github.com:companieshouse/terraform-modules//aws/alb-cloudwatch-alarms | tags/1.0.354 |
...
| [aws_resourcegroups_group.rg_ceu](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/resourcegroups_group) | resource |
...
| [aws_network_interface.ceu_internal_nlb](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/network_interface) | data source |
...
| [vault_generic_secret.ceu_fe_nlb_subnet_mappings](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/data-sources/generic_secret) | data source |
...
| <a name="input_fe_nlb_static_addressing"></a> [fe\_nlb\_static\_addressing](#input\_fe\_nlb\_static\_addressing) | Controls whether to define static IP addressing through the use of an NLB (true) or use the default dynamic addressing (false) | `bool` | `false` | no |
